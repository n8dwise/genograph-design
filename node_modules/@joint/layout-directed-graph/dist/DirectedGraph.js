/*! JointJS LayoutDirectedGraph v4.2.3 (2026-01-21) - LayoutDirectedGraph module for JointJS
...
(function (global, factory) {
    ...
    const DirectedGraph = {
        ...
        importElement: function(nodeId, glGraph, graph, opt) {
            ...
            if (core.util.isFunction(opt.setPosition)) {
        ...
        layout: function(graphOrCells, opt) {
            ...
            if (graphOrCells instanceof core.dia.Graph) {
                ...
                graph = new core.dia.Graph(null, { ignoreLayers: true });
            ...
            var glLabel = {};
            var marginX = (core.util.isNumber(opt.marginX)) ? opt.marginX : 0;
            var marginY = (core.util.isNumber(opt.marginY)) ? opt.marginY : 0;
            ...
            if (core.util.isNumber(opt.nodeSep)) glLabel.nodesep = opt.nodeSep;
            // Number of pixels that separate edges horizontally in the layout.
            if (core.util.isNumber(opt.edgeSep)) glLabel.edgesep = opt.edgeSep;
            // Number of pixels between each rank in the layout.
            if (core.util.isNumber(opt.rankSep)) glLabel.ranksep = opt.rankSep;
            ...
            let customOrder;
            if (core.util.isFunction(opt.customOrder)) {
            ...
            // Executes the layout.
            dagreUtil__namespace.layout(glGraph, {
            ...
            if (opt.resizeClusters && (opt.clusterPadding !== 'default')) {
                ...
                core.util.invoke(topLevelClusters, 'fitToChildren', { padding: opt.clusterPadding, deep: true });
            }
        ...
        toGraphLib: function(graph, opt = {}) {
            ...
            const glGraphType = core.util.pick(opt, 'directed', 'compound', 'multigraph');
            const glGraph = new graphlibUtil__namespace.Graph(glGraphType);
            const setNodeLabel = opt.setNodeLabel || core.util.noop;
            const setEdgeLabel = opt.setEdgeLabel || core.util.noop;
            const setEdgeName = opt.setEdgeName || core.util.noop;
